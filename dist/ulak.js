...
`,g=e.logs;return new Blob([n,t,o,s,l,g],{type:"plain/text"})}var w="Ulak";function ke(e,t){alert(`Success ${e} message: ${t}`),window.dispatchEvent(new CustomEvent(K.SENDING_DONE_EVENT_NAME,{detail:{success:e,message:t}}))}function Q(){u||(window.addEventListener(K.SEND_EVENT_NAME,e=>{ne(),F(e.detail.screenshot,e.detail.message).then(()=>{W(ke)})}),c()&&console.debug(w,"Registering message handler."),window.addEventListener("message",async e=>{let t=e.origin,n=e.source,o=e.data;if(Be(e))return;if(Le(t)){c()&&console.debug(w,`Event from '${t}' is not trusted, ignoring...`);return}if(typeof o!="object"||typeof o.type!="string"||o.type.length===0){c()&&console.debug(w,`Event data from '${t}' is invalid.`,o);return}let s=o.type;switch(c()&&console.debug(w,"eventHandlers",window.location.href,o.type,o.data),s){case O:{F();break}case A:{let l={type:U,payload:await L()};console.log("response.payload.screenshot",l.payload.screenshot),n.postMessage(l,t);break}case U:{te(o.payload);break}default:c()&&console.debug(w,`Invalid event type: '${s}'.`)}}))}function Le(e){return c()&&console.debug(w,`Checking if '${e}' is trusted or not.`),!1}var Pe=["react-devtools-content-script","react-devtools-bridge"];function Be(e){return Pe.includes(e?.data?.source)}var m="UlakLog",ae=2e5,J="Ulak",b=function(){},S={trace:"T",debug:"D",log:"L",info:"I",warn:"W",error:"E"},De=u?b:console.log.bind(window.console),Me=u?b:console.trace.bind(window.console),$e=u?b:console.debug.bind(window.console),X=u?b:console.info.bind(window.console),le=u?b:console.warn.bind(window.console),Ue=u?b:console.error.bind(window.console),de=Date.now(),h="",ce=!1,Z=!1,y=0,v=0;Q();function Ce(e,t){let n=[Date.now()-de,t];for(let o of e)typeof o>"u"?n.push("undefined"):typeof o=="object"?o instanceof Error?n.push(o.stack||o.toString()):n.push(JSON.stringify(o)):typeof o=="boolean"||typeof o=="number"||typeof o=="bigint"||typeof o=="string"||typeof o=="symbol"?n.push(o):typeof o=="function"?n.push(`[Function ${o.name}]`):n.push(`[Unrecognized type ${o}]`);return n.join(" ")}function Ve(e){if(h+=`
`+e,!(h.length<ae))try{let t=m+y++;v=Math.max(v,y),X(J,"writing to storage",t),sessionStorage.setItem(t,h.substring(h.length-ae)),h="",X(J,"written to storage",t)}catch(t){Z=!0,!!sessionStorage.getItem(m+y)||(y=0),sessionStorage.removeItem(m+y),console.error(`Session storage is full. e.code '${t.code}' e.name ${t.name}`)}}function T(e,t){let n=Ce(e,t);Ve(n)}function Fe(){T(arguments,S.log)}function Ye(){T(arguments,S.trace)}function He(){T(arguments,S.debug)}function Ke(){T(arguments,S.info)}function je(){T(arguments,S.warn)}function Ge(){T(arguments,S.error)}function P(){let e=[];for(let o=0;o<v;o++){let s=sessionStorage.getItem(m+o);s&&e.push(s)}let t=Z?`[Session storage quota exceeded, logs may be not ordered by time!]
`:"",n=`
Start time: ${de}
`;return _+n+t+e.join("")+h}function M(){h="";for(let e=0;e<v;e++)sessionStorage.removeItem(m+e);y=0,v=0,Z=!1}function ue(){!ce&&x?(window.console.log=function(){De.apply(window.console,arguments),Fe.apply(null,arguments)},window.console.trace=function(){Me.apply(window.console,arguments),Ye.apply(null,arguments)},window.console.debug=function(){$e.apply(window.console,arguments),He.apply(null,arguments)},window.console.info=function(){X.apply(window.console,arguments),Ke.apply(null,arguments)},window.console.warn=function(){le.apply(window.console,arguments),je.apply(null,arguments)},window.console.error=function(){Ue.apply(window.console,arguments),Ge.apply(null,arguments)},ce=!0):le(J,"Console is already intercepted!")}console.info(_);
